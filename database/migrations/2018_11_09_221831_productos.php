...
class Productos extends Migration
{
	...
	public function up()
	{
		Schema::create('productos', function (Blueprint $table) {
			...
			$table -> foreign('idcatnum1') -> references('id')->on('catums') -> onDelete('cascade');
			$table -> integer('idcatnum2') -> unsigned(11) -> nullable();
			$table -> foreign('idcatnum2') -> references('id')->on('catums') -> onDelete('cascade');
			$table -> integer('idcatnum3') -> unsigned(11) -> nullable();
			$table -> foreign('idcatnum3') -> references('id')->on('catums') -> onDelete('cascade');
