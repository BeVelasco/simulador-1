						...
						<div class="form-group form-float" style="margin-bottom: 25px !important;">
							...
							<div class="row">
								...
								<div class="col-sm-8 col-lg-8 col-md-8">
									...
									<p class="text-justify">{{ __('messages.bajacanales') }}</p>
								</div>
								<div class="col-sm-4 col-lg-4 col-md-4">
									<div class="form-group form-float no-bottom-padding">
										<div class="form-line">
								...
								<div class="col-sm-8 col-lg-8 col-md-8">
									...
									<p class="text-justify">{{ __('messages.bajaproducto') }}</p>
								</div>
								<div class="col-sm-4 col-lg-4 col-md-4">
									<div class="form-group form-float no-bottom-padding">
										<div class="form-line">
								...
								<div class="col-sm-8 col-lg-8 col-md-8">
									...
									<p class="text-justify">{{ __('messages.bajarelaciones') }}</p>
								</div>
								<div class="col-sm-4 col-lg-4 col-md-4">
									<div class="form-group form-float no-bottom-padding">
										<div class="form-line">
								...
								<div class="col-sm-8 col-lg-8 col-md-8">
									...
									<p class="text-justify">{{ __('messages.bajaclientesi') }}</p>
								</div>
								<div class="col-sm-4 col-lg-4 col-md-4">
									<div class="form-group form-float no-bottom-padding">
										<div class="form-line">
